...
$(window).on('load', function(){
    ...
    //     $(this).siblings(".slide").toggleClass("selected"); 
    // });
   
      $(".artist-single").hover(function(){

        $(this).children().children(".slide").toggleClass("selected"); 
...
// });
      ...
      $(".event-select").click(function(){
        ...
        $(".event-tabs").css("display", "none");  
         $('html, body').animate({
        scrollTop: $("#event-name").offset().top
    }, 1000);
       // $("#tab_"+this.id).css("display", "block"); works

       //$(".event-tabs").fadeOut("slow"); works
    ...
    // $( document ).ready(function() {
     ...
     // var hash = (window.location.hash).replace('#', '');
        ...
        // $("#etab"+parseInt(hash)).css("display", "block");
...
// });
    ...
    $(function() {
        ...
        $('.tab-nav').bind('click', function(e) {
            ...
            $this.parent().parent().children(".tabs-container").children().css("display", "none");

            $this.parent().parent().children(".tabs-container").children($this.data("target")).css("display", "block");
    ...
    // var hash = (window.location.hash).replace('#', '');
        // $('.accordion-wrap .entry-title').removeClass('active'); // saif added
        // console.log("c:" + hash.substring(0, 2));
         // $(".accordion-wrap:nth-of-type("+parseInt(hash.substring(0, 2))+")").trigger('click');
         // $(".entry-title:nth-of-type("+parseInt(hash.substring(0, 2))+")").trigger('click');
        // $("#etab"+parseInt(hash.substring(0, 2))).addClass('active');
