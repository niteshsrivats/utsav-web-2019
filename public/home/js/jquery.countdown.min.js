							...
							if(!t[o])
								...
								for(var o=0;o<r.length;o++)s(r[o]);
									return s}({1:[function(require,module,exports)
										{
											var defaultOptions={date:"April 14, 2018 09:00:00",refresh:1e3,offset:0,onEnd:function()
											{
												return
																													...
																													if(this.interval)
																														...
																														if(this.options.refresh)
																															...
																															this.updateOffset=function(offset)
																															{
																																...
																																return this}.bind(this);
																																this.start()};
																																module.exports=Countdown},{}],2:[function(require,module,exports)
																																{
																																		...
																																		return $.each(this,function(i,el)
																																			{
																																				...
																																				if(!$el.data(NAME))
																																					...
																																					{
																																						options.date=$el.data(DATA_ATTR)}$el.data(NAME,new Countdown(el,options))}})};
																																		module.exports=Countdown},{"./countdown.js":1}]},{},[2])(2)});